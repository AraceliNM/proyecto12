...
class SortableTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->sortable = new Sortable('http://proyecto12/demo');
    }
    ...
    {
        $this->assertSame(
            'http://proyecto12/demo?order=first_name&direction=asc',
    ...
    public function builds_a_url_with_descendent_order_if_the_current_column_matches_the_given_one_and_the_current_direction_is_asc()
    {
        ...
        $this->assertSame(
            'http://proyecto12/demo?order=first_name&direction=desc',
            $this->sortable->url('first_name')
        );
    }
}
